...
OfflineSessionResponse OfflineSessionResponseFromJson(String str) =>
    OfflineSessionResponse.fromJson(json.decode(str));

String OfflineSessionResponseToJson(OfflineSessionResponse data) =>
    json.encode(data.toJson());

class OfflineSessionResponse {
  ...
  factory OfflineSessionResponse.fromJson(Map<String, dynamic> json) =>
      OfflineSessionResponse(
        day: json["day"],
        month: json["month"],
        hour: json["hour"],
